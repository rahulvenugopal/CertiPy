...
font = ImageFont.truetype('PlayfairDisplay-Regular.ttf', 150)
...
for index,j in participant_names.iterrows():
    ...
    draw.text(xy = (3400-(5*w),2558),text = name_to_add,
              fill=(0,0,0),font = font)
    
    # Saving the image
    # You can change the format to PDf by replacing jpg
    img.save('certificate_generated/{}_Certificate.PDF'.format(j['ID']))
